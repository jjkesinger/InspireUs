...
{
    public partial class MemberWebScrapingService : WebScrapingService<Member>
    {
        private readonly ILogger _logger;

        public MemberWebScrapingService(
        ...
        protected override void PopulateData()
        {
            ...
            if (memberElements.Any())
            {
                ...
                {
                    if (member.Text.StartsWith("MEMBER"))
                    {
                        ...
                        _logger.LogTrace($"Adding member: {JsonSerializer.Serialize(obj)}");
